...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    update_data: function update_data(id) {
      var _this = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.patch(window.location.href + "api/contact/".concat(id), this.contact).then(function (response) {
        console.log(response);
        _this.contacts_list = _this.contacts_list.map(function (contact) {
    ...
    create_data: function create_data() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(window.location.href + 'api/contact/store', this.contact).then(function (response) {
        _this2.contacts_list.unshift(response.data);

        _this2.clear_form();
      });
    },
    set_update: function set_update(id) {
      var _this3 = this;

      this.update_id = id;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(window.location.href + "api/contact/".concat(id)).then(function (response) {
        _this3.contact = response.data;
      });
    },
    delete_contact: function delete_contact(id) {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"](window.location.href + "api/contact/".concat(id)).then(function (response) {
        _this4.contacts_list = _this4.contacts_list.filter(function (contact) {
          return contact.id !== id;
        });
      });
    },
    set_create: function set_create() {
      this.update_id = null;
    }
  },
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(window.location.href + 'api/contacts').then(function (response) {
      _this5.contacts_list = response.data;
    });
  }
});
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Container.vue?vue&type=style&index=0&lang=css&":
/*!***************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Container.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Container.vue?vue&type=style&index=0&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Container.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "columns" }, [
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "content" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "control mt-4" }, [
                    !_vm.update_id
                      ? _c(
                          "button",
                          {
                            staticClass:
                              "button is-fullwidth is-rounded is-primary",
                            attrs: { type: "submit" }
                          },
                          [_vm._v("Add Contact")]
                        )
                      : _c("div", { staticClass: "columns" }, [
                          ...
                          _c("div", { staticClass: "column" }, [
                            _c(
                              ...
                              {
                                staticClass:
                                  "button is-fullwidth is-rounded is-danger",
                                attrs: { type: "submit" },
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.set_create($event)
                                  }
                                }
                              },
                              [_vm._v("Cancel")]
      ...
      _c("div", { staticClass: "column is-8" }, [
        _c("div", { staticClass: "card mt-5" }, [
          _c("div", { staticClass: "card-content" }, [
            _c("h2", { staticClass: "title is-4 has-text-centered" }, [
              _vm._v("Contacts")
            ]),
            _vm._v(" "),
            _c(
              ...
              _vm._l(_vm.contacts_list, function(item) {
                return _c("div", { staticClass: "column is-6" }, [
                  _c("article", { staticClass: "message" }, [
                    ...
                    _c("div", { staticClass: "message-body" }, [
                      ...
                      _c("div", [
                        _vm._v("Phone: "),
                        _c("strong", [_vm._v(_vm._s(item.phone))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "mt-3" }, [
                        _c(
                          "span",
                          { staticClass: "tag is-rounded is-primary" },
                          [
                            _c(
                              "a",
                              {
                        ...
                        _c(
                          "span",
                          { staticClass: "tag is-rounded is-danger" },
                          [
                            _c(
                              "a",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.delete_contact(item.id)
                                  }
                                }
                              },
                              [_vm._v("Delete")]
...
/* empty/unused harmony star reexport *//* harmony import */ var _Container_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Container.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/Container.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./resources/js/components/Container.vue?vue&type=style&index=0&lang=css&":
/*!********************************************************************************!*\
  !*** ./resources/js/components/Container.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************/
/*! no static exports found */
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Container_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Container_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Container_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
__webpack_require__(/*! C:\Users\sam_T\Documents\projects\contactstore\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\sam_T\Documents\projects\contactstore\resources\sass\app.scss */"./resources/sass/app.scss");
